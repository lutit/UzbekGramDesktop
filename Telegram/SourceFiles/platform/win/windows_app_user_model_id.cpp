...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"UzbekGram.Desktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"UzbekGram.Desktop";
#endif // OS_WIN_STORE
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"UzbekGram Desktop/Telegram.lnk"_q;
